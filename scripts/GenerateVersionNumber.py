...
- C++ version header file containing the version number as well as additional build information
  (i.e. build user, build time, Git commit hash, compiler identifier, compiler version, and build
  type), which can be compiled into a binary.
...
if __name__ == "__main__":
    ...
    argument_parser.add_argument("-cv",
                                 ...
                                 required=True)
    argument_parser.add_argument("-bt",
                                 "--build_type",
                                 type=str,
                                 help="Build type.",
                                 required=True)
    ...
    VG.write_version_header_file(args.compiler_identifier, args.compiler_version, args.build_type, Path(args.output_path, args.filename_version_header))
