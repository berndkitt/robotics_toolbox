...
/// of randomly generated 3d world points. The 3d world points generated will be located inside a
...
public:
    ...
    /// \brief Constructor.
    ///
    /// Initializes the member variables of the class and generates uniform distributions in X-, Y-,
    /// and Z-direction, which will be used to generate the 3d world points inside the cuboid of
    /// predefined extend. Afterwards, the set of 3d world points is being generated by calling the
    /// GeneratePointCloud() method.
    ///
...
private:
    ...
    ///
    /// Randomly generates a single 3d world point inside a cuboid of predefined extend.
    ///
